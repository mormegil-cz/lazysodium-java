...
public interface Auth {
    ...
    interface Native {
         ...
         */
        boolean cryptoAuth(byte[] tag, byte[] in, int inLen, byte[] key);
         ...
         */
        boolean cryptoAuthVerify(byte[] tag, byte[] in, int inLen, byte[] key);
    ...
    interface Lazy {
         ...
         * @throws SodiumException if the operation could not be completed
         */
